...
Role.initColumn = function () {
    var columns = [
        ...
        {title: '名称', field: 'name', align: 'center', valign: 'middle', sortable: true, cellStyle:Feng.formatTableUnit, formatter:Feng.paramsMatter},
        {title: '上级角色', field: 'pName', align: 'center', valign: 'middle', sortable: true, cellStyle:Feng.formatTableUnit, formatter:Feng.paramsMatter},
        {title: '所在部门', field: 'deptName', align: 'center', valign: 'middle', sortable: true, cellStyle:Feng.formatTableUnit, formatter:Feng.paramsMatter},
        {title: '别名', field: 'tips', align: 'center', valign: 'middle', sortable: true, cellStyle:Feng.formatTableUnit, formatter:Feng.paramsMatter}]
    return columns;
};
