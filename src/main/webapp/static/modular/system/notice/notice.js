...
Notice.initColumn = function () {
    return [
        ...
        {title: '标题', field: 'title', align: 'center', valign: 'middle', sortable: true, cellStyle:Feng.formatTableUnit, formatter:Feng.paramsMatter},
        {title: '内容', field: 'content', align: 'center', valign: 'middle', sortable: true, cellStyle:Feng.formatTableUnit, formatter:Feng.paramsMatter},
        {title: '发布者', field: 'createrName', align: 'center', valign: 'middle', sortable: true, cellStyle:Feng.formatTableUnit, formatter:Feng.paramsMatter},
